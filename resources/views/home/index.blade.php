                ...
                <div class="carousel slide" data-bs-ride="carousel" id="carouselExample">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div class="col-md-3">
                                <a href="/portofolio"><img src="assets/img/kategori/apart.png" class="img-fluid"
                                        alt="one"></a>
                        ...
                        <div class="carousel-item">
                            <div class="col-md-3">
                                <a href="/portofolio"><img src="assets/img/kategori/livingroom.png" class="img-fluid"
                                        alt="two"></a>
                        ...
                        <div class="carousel-item">
                            <div class="col-md-3">
                                <a href="/portofolio"><img src="assets/img/kategori/bedroom.png" class="img-fluid"
                                        alt="three"></a>
                        ...
                        <div class="carousel-item">
                            <div class="col-md-3">
                                <a href="/portofolio"><img src="assets/img/kategori/cafe.png" class="img-fluid"
                                        alt="four"></a>
                        ...
                        <div class="carousel-item">
                            <div class="col-md-3">
                                <a href="/portofolio"><img src="assets/img/kategori/kitchen.png" class="img-fluid"
                                        alt="five"></a>
        ...
        <section id="workflow" class="workflow">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-1 col-md-4 col-6" style="padding: 0 150px 0 0" data-aos="fade-up"
                        data-aos-delay="100">
                        <div class="post-item position-relative h-100">
                    ...
                    <div class="col-lg-1 col-md-4 col-6" style="padding: 0 0 0 0" data-aos="fade-up"
                        data-aos-delay="100">
                        <div class="post-item position-relative h-100">
                        ...
                        <form class="php-email-form">
                            ...
                            <div class="form-group mt-3">
                                <input type="text" name="hasil" class="form-control" id="hasil"
                                    placeholder="Hasil" disabled readonly>
                            </div><br>
